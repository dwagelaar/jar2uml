 ...
 */
public class JavaProjectToUMLImportDependenciesWizard extends Wizard implements IImportWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		mainPage = new JavaProjectToUMLImportDependenciesWizardPage(
				"Import Java Project Dependencies to UML Models",
				"Import dependencies of a Java project into a UML model in the workspace",
